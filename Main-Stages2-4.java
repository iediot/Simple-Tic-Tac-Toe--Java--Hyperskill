...
public class Main {
    ...
    /// This modification is brought by the fact that for this
    /// task I needed to print the grid twice, so I decided to
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        */
         ...
         */
        /// --- Fourth version of the code ---
        /// The task was very simple, I needed to reuse most of the code
        /// before, meaning the functionality didn't change much, only
        /// adding the possibility to make one singular move as the 'X'
        /// player.
        /*
        java.util.Scanner scanner = new java.util.Scanner(System.in);
        char[][] ticTacToeGrid = new char[4][4];
        ...
        while (true) {
            ...
            else if (ticTacToeGrid[x - 1][y - 1] == '_') {
